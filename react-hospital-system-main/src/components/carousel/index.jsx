                    ...
                    <div className="Carousel-div">
                        <a href="http://www.sj-hospital.org/">
                            <img className="Carousel-img"
                                 src="http://sjres.daxiang91.com/elho/M00/00/00/rBzrtV1o9pOAEnGbAAXbUDexMFg374.png"
                                 alt=""/>
                        </a>
                    </div>
                    <div className="Carousel-div">
                        <a href="http://www.sj-hospital.org/">
                            <img className="Carousel-img"
                                 src="http://sjres.daxiang91.com/elho/M00/00/00/rBzrtV1o9x6AaMeNAASN0Wmsvzg607.png"
                                 alt=""/>
                        </a>
                    </div>
                    <div className="Carousel-div">
                        <a href="http://www.sj-hospital.org/">
                            <img className="Carousel-img"
                                 src="http://www.sj-hospital.org/upload/20170726/201707261523431418688449.jpg" alt=""/>
                        </a>
                    </div>
                </Carousel>
                <div>
