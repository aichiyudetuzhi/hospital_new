...
class Order extends React.Component {
    ...
    getCarousel = async () => {
        this.getRegister();
        let url = `http://localhost:8001/register/addRegister`;
        xhaxios(url,this.register);
    }
    getRegister =()=>{
        this.register.uid=JSON.parse(localStorage.getItem("user_token")).data.login.uid;
        this.register.department=this.state.department.toString();
        this.register.doctor=this.state.doctor.toString();
        this.register.money=this.state.money;
        this.register.pay_status="未支付";
        this.register.registerDate=this.state.RegisterDate;
        this.register.registerTime=this.state.RegisterTime;
        this.register.type=this.state.type.toString();
    }
        ...
        return (<div>
            ...
            <List style={{backgroundColor: 'white'}} className="picker-list">
                ...
                <DatePicker
                    ...
                    onChange={RegisterDate => this.setState({RegisterDate})}
                    onOk={e => console.log('ok', e)}
                >
                ...
                <DatePicker
                    ...
                    value={this.state.RegisterTime}
                    onChange={
                        RegisterTime => this.setState({RegisterTime})
                    }
                    onOk={e => console.log('ok', e)}
                >
